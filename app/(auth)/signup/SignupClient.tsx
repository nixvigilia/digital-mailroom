...
import {useActionState, useEffect, useState, startTransition, use} from "react";
...
export function SignupClient({referralCode}: SignupClientProps) {
                ...
                <>
                  {referralCode && (
                    <Alert
                      ...
                      mb="lg"
                      styles={{
                        root: {borderColor: "var(--mantine-color-green-3)"},
                        message: {color: "var(--mantine-color-green-8)"},
                      }}
                    >
                      <Text component="div" size="sm">
                        Join Keep PH and access your mail digitally anytime,
                        anywhere.
                      </Text>
                    </Alert>
                  )}
